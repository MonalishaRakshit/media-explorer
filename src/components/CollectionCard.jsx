...
const CollectionCard = ({ item }) => {
  ...
  return (
    <div className="w-[18vw] h-80 relative bg-white rounded-xl overflow-hidden">
      ...
      >
        <h2 className="text-lg font-semibold h-13 overflow-hidden capitalize">
          {item.title}
        </h2>
        <button
          onClick={() => {
          ...
          className="bg-blue-800 active:scale-95 text-white rounded px-3 py-1 cursor-pointer font-medium"
        >
          Remove
        </button>
      </div>
